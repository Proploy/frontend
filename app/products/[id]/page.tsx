    ...
    <div className="min-h-screen bg-[#F8FAFC] pt-32 lg:pt-36 font-inter">
      <AgentContextBridge
        context={{
          ...
          productCategory: product.category?.name || product.category?.link || undefined,
          summary: `${product.product_name} is being viewed with rating ${product.rating?.toFixed(1) || 'n/a'} and ${product.reviews || 0} reviews.`,
        }}
      />
