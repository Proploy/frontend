...
// structure we still want to carry over (logo, nav items, footer IA).
// The global Navbar + SiteFooter render on this route, so it shows the legacy
// chrome as well. Delete once the v2 migration is complete.
