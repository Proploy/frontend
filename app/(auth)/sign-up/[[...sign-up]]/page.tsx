...
/**
 * Custom Sign-Up Page
 * Two-column layout matching the sign-in page design
 */
  ...
  return (
    <div className="min-h-screen bg-[#F8F7F4] flex flex-col">
      ...
      <div className="flex-1 flex pt-[120px]">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center items-center px-8 lg:px-16">
          <div className="w-full max-w-[239px]">
            <h1 className="text-[24px] font-bold text-gray-900 mb-[40px] text-center lg:text-left font-dm-sans">
              {pendingVerification ? 'Verify Your Email' : 'Join Proploy'}
            </h1>
            ...
            {pendingVerification ? (
              ...
              <form onSubmit={handleVerification} className="space-y-[16px]">
                <p className="text-[#666666] text-[12px] mb-4 font-inter">
        ...
        {/* Right Side - Banner Image with Text Overlay */}
